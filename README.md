...
Shanghai Boshu Technology （这个项目的拥有者，以下简称“我们”）尊重并保护用户的隐私权。为了给您提供一个更好的环境，我们严格根据本隐私权政策的内容使用您的个人信息。请仔细阅读以下内容以更好地理解我们并防止可能的争吵。  
...
***
**本协议最终解释权归 Shanghai Boshu Technology 所有。**
